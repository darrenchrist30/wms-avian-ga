...
@section('title', 'Warehouse / Gudang')

@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h3 class="mt-2">Warehouse / Gudang</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="font-weight-bold">
                                <i class="fas fa-warehouse mr-1"></i> Daftar Warehouse
                            </div>
                            <div class="btn-group">
...
@push('scripts')
    <script>
        $(document).ready(function() {
            var baseURL = "{{ route('location.warehouses.datatable') }}";
            var routeDestroy = "{{ route('location.warehouses.destroy', ':id') }}";
            ...
            $(document).on('click', '.btnDel', function(e) {
                ...
                Swal.fire({
                    ...
                    html: 'Warehouse <strong>' + name + '</strong> akan dihapus permanen.',
                    icon: 'warning',
