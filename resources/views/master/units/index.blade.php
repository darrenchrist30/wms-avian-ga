                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="font-weight-bold">
                                <i class="fas fa-ruler-combined mr-1"></i> Daftar Satuan
                            </div>
                            <div class="btn-group">
                                ...
                                <a href="{{ route('master.units.create') }}" class="btn btn-sm btn-outline-dark">
...
@push('scripts')
    <script>
        $(document).ready(function() {
            var baseURL = "{{ route('master.units.datatable') }}";
            var routeDestroy = "{{ route('master.units.destroy', ':id') }}";
