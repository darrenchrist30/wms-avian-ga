...
══════════════════════════════════════════════════════ --}}
    @php
        ...
        $visibleActionCards = [];
        if ($inboundHariIni > 0) {
            $visibleActionCards[] = ['label' => 'SJ baru tiba dan belum diproses', 'count' => $inboundHariIni];
        }
        if ($pendingQtyConfirm > 0) {
            $visibleActionCards[] = ['label' => 'SJ menunggu konfirmasi qty fisik', 'count' => $pendingQtyConfirm];
        }
        if (!$isOperatorDashboard && $pendingGaRun > 0) {
            $visibleActionCards[] = ['label' => 'SJ siap diproses GA', 'count' => $pendingGaRun];
        }
        if (!$isOperatorDashboard && $pendingGaAccept > 0) {
            $visibleActionCards[] = ['label' => 'SJ menunggu review rekomendasi GA', 'count' => $pendingGaAccept];
        }
        if ($pendingPutAway > 0) {
    ...
    @if ($totalPending > 0)
        <div class="alert mb-3 py-2 px-3 d-flex align-items-center justify-content-between flex-wrap"
            ...
            <div>
                ...
                <strong>{{ number_format($totalPending) }} SJ perlu diproses</strong>
        ...
        <div class="row mb-3">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <div class="d-flex align-items-baseline" style="gap:4px">
                                        ...
                                        <span class="font-weight-bold"
                                            style="font-size:22px;color:#c53030;line-height:1">SJ</span>
                                    </div>
                                </div>
                                <div style="font-size:12px;font-weight:600;color:#c53030">Inbound Datang Hari Ini</div>
                                <div style="font-size:11px;color:#6c757d;margin-top:2px">Surat jalan tiba, belum diproses
                                </div>
                                <div class="mt-2">
                            ...
                            <div class="card-body py-3 px-3">
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <div class="d-flex align-items-baseline" style="gap:4px">
                                        ...
                                        <span class="font-weight-bold"
                                            style="font-size:22px;color:#343a40;line-height:1">SJ</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <div class="d-flex align-items-baseline" style="gap:4px">
                                            <div class="font-weight-bold"
                                                style="font-size:22px;color:#1e40af;line-height:1">
                                                {{ $pendingGaRun }}
                                            </div>
                                            <span class="font-weight-bold"
                                                style="font-size:22px;color:#1e40af;line-height:1">SJ</span>
                                        </div>
                                    </div>
                                    <div style="font-size:12px;font-weight:600;color:#1e40af">Jalankan Genetic Algorithm
                                    </div>
                            ...
                            <div class="card border-0 shadow-sm h-100"
                                ...
                                <div class="card-body py-3 px-3">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <div class="d-flex align-items-baseline" style="gap:4px">
                                            <div class="font-weight-bold"
                                                style="font-size:22px;color:#b45309;line-height:1">
                                                {{ $pendingGaAccept }}
                                            </div>
                                            <span class="font-weight-bold"
                                                style="font-size:22px;color:#b45309;line-height:1">SJ</span>
                                        </div>
                                    </div>
                                    <div style="font-size:12px;font-weight:600;color:#b45309">Review Rekomendasi GA</div>
                                    <div style="font-size:11px;color:#6c757d;margin-top:2px">Hasil GA perlu review
                                        Supervisor (<code style="font-size:10px;">pending_review</code>)
                                    </div>
                                    <div class="mt-2">
            ...
            @if ($pendingPutAway > 0)
                <div class="col-12 col-md-6 mb-2">
                    <a href="{{ route('putaway.operator') }}" class="d-block text-decoration-none">
                        <div class="card border-0 shadow-sm h-100"
                            ...
                            <div class="card-body py-3 px-3">
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <div class="d-flex align-items-baseline" style="gap:4px">
                                        ...
                                        <span class="font-weight-bold"
                                            style="font-size:22px;color:#065f46;line-height:1">SJ</span>
                                    </div>
                                </div>
        ...
        <div class="col-6 col-md-3 mb-3">
            <a href="{{ route('master.items.index') }}" class="kpi-link">
                <div class="kpi-card kpi-green">
                    ...
                    <div class="kpi-trend"><span class="up">{{ number_format($mappedSku) }} SKU memiliki stok di
                            denah</span></div>
                </div>
            </a>
        </div>
        ...
        <div class="col-6 col-md-3 mb-3">
            <a href="{{ route('stock.index') }}" class="kpi-link">
                <div class="kpi-card kpi-slate">
                    ...
                    <div class="kpi-trend"><span class="up">Akumulasi qty · {{ number_format($mappedSku) }} SKU ·
                            unit/satuan</span></div>
                </div>
            </a>
        </div>
        <div class="col-6 col-md-3 mb-3">
            <a href="{{ route('location.cells.index') }}" class="kpi-link">
                <div class="kpi-card" style="background:linear-gradient(135deg,#be185d,#f43f5e);">
                    ...
                    <div class="kpi-trend"><span class="up">{{ number_format($denahSku) }} dari
                            {{ number_format($totalItems) }} SKU master</span></div>
                </div>
            </a>
        </div>
    </div>
...
══════════════════════════════════════════════════════ --}}
    @php
        $locationIssues =
            ($stockNoLocation > 0 ? 1 : 0) + ($stockLegacyCell > 0 ? 1 : 0) + ($itemsNoCategory > 0 ? 1 : 0);
        $totalAlerts =
        ...
        <div class="tab-content" id="dashboardTabContent">
                        ...
                        <div class="panel-card">
                            <div class="panel-header" style="flex-wrap:wrap;gap:8px;">
                                ...
                                <div class="d-flex align-items-center" style="gap:6px;">
                                    <input type="date" id="trendFrom" class="form-control form-control-sm"
                                        style="width:130px;" />
                                    <span style="font-size:12px;color:#6b7280;">–</span>
                                    <input type="date" id="trendTo" class="form-control form-control-sm"
                                        style="width:130px;" />
                            ...
                            <div class="panel-body">
                                ...
                                <div class="capacity-stats">
                                    <div class="capacity-stat">
                                        <strong id="trendInboundStat"
                                            style="color:#0d8564">{{ number_format($trendInboundTotal) }}</strong>
                                        <span>Total Inbound</span>
                                    </div>
                                    <div class="capacity-stat">
                                        <strong id="trendOutboundStat"
                                            style="color:#3b82f6">{{ number_format($trendOutboundTotal) }}</strong>
                                        <span>Pergerakan Keluar</span>
                                    </div>
                                    <div class="capacity-stat">
                                        <strong id="trendNetFlowStat"
                                            style="color:{{ $trendNetFlow >= 0 ? '#0d8564' : '#ef4444' }}">{{ number_format($trendNetFlow) }}</strong>
                                        <span>Net Flow</span>
                                    </div>
                                </div>
            ...
            <div class="tab-pane fade" id="tab-antrian" role="tabpanel">
                ...
                <div class="row process-row">
                    <div class="col-md-7">
                        <div class="panel-card process-card">
                            <div class="panel-header">
                                <h6><i class="fas fa-dolly-flatbed mr-1 text-success"></i> Progress Put-Away</h6>
                                {{-- <span style="font-size:12px;color:#6b7280;">Status penempatan barang per SJ</span> --}}
                            </div>
                            <div class="panel-body p-0">
                                ...
                                @else
                                    <div style="max-height:260px;overflow-y:auto;">
                                        @foreach($putAwayProgressToday as $row)
                                            @php $color = $row['pct'] >= 100 ? '#0d8564' : ($row['pct'] >= 50 ? '#14b8a6' : '#f59e0b'); @endphp
                                            <div style="padding:10px 16px;border-bottom:1px solid #f3f4f6;">
                                                <div class="d-flex justify-content-between align-items-center mb-1">
                                                    <div>
                                                        <a href="{{ route('putaway.show', $row['id']) }}" class="font-weight-bold" style="font-size:13px;color:#065f46;text-decoration:none;">
                                                            {{ $row['do_number'] }}
                                                        </a>
                                                        <span class="text-muted" style="font-size:11px;margin-left:6px;">{{ $row['warehouse'] }}</span>
                                                    </div>
                                                    <div class="d-flex align-items-center" style="gap:8px;">
                                                        @if($row['last_activity'])
                                                            <span class="text-muted" style="font-size:10px;"><i class="fas fa-clock mr-1"></i>{{ $row['last_activity'] }}</span>
                                                        @endif
                                                        <span style="font-size:12px;font-weight:600;color:{{ $color }};">{{ $row['done'] }}/{{ $row['total'] }} item</span>
                                                        <span style="font-size:11px;color:{{ $color }};font-weight:700;min-width:34px;text-align:right;">{{ $row['pct'] }}%</span>
                                                    </div>
                                                </div>
                                                <div style="height:5px;background:#e9ecef;border-radius:3px;overflow:hidden;">
                                                    <div style="height:5px;width:{{ $row['pct'] }}%;background:{{ $color }};border-radius:3px;"></div>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
                    ...
                    <div class="col-md-5">
                        <div class="panel-card process-card">
                            <div class="panel-header">
                                <h6><i class="fas fa-stopwatch mr-1 text-danger"></i> Surat Jalan Terlama</h6>
                            </div>
                            <div class="panel-body p-0">
                                    ...
                                    <tbody>
                                        @forelse($oldestOpenOrders as $order)
                                            ...
                                            <tr style="cursor:pointer;" onclick="location.href='{{ $orderUrl }}'">
                                                ...
                                                <td><span
                                                        class="badge badge-status badge-pending">{{ ucfirst(str_replace('_', ' ', $order['status'])) }}</span>
                                                </td>
            ...
            <div class="tab-pane fade" id="tab-kapasitas" role="tabpanel">
                        ...
                        <div class="panel-card capacity-card">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="mt-2" style="font-size:12px;">
                                    ...
                                    @endforeach
                                    @if ($totalOrders === 0)
                                        <div class="text-center text-muted py-2" style="font-size:12px">Belum ada order
                                        </div>
                                    @endif
                                </div>
                                @if ($completionRate > 0)
                ...
                @if ($criticalCells->isNotEmpty())
                    <p class="section-title mt-0" style="margin-top:8px !important;"><i
                            class="fas fa-exclamation-circle mr-1" style="color:#f59e0b;"></i> Top Cell / Rak Hampir Penuh
                    </p>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="panel-card">
                                <div class="panel-header">
                                    ...
                                    <span style="font-size:12px;color:#6b7280;">{{ $criticalCells->count() }} cell
                                        dimonitor</span>
                                </div>
                                <div class="panel-body">
                                        ...
                                        <div class="zone-row">
                                            <div class="zone-label">
                                                <span style="font-size:12px;">
                                                    ...
                                                    <span class="text-muted ml-1" style="font-size:11px;">Rak:
                                                        {{ $cell['rack'] }}</span>
                                                </span>
                                                <span
                                                    style="font-size:12px;font-weight:600;color:{{ $pct >= 100 ? '#ef4444' : ($pct >= 85 ? '#f59e0b' : '#14b8a6') }};">
                                                    {{ $cell['used'] }}/{{ $cell['max'] }} · {{ $pct }}%
                                                </span>
                                            </div>
                                            <div class="zone-bar">
                                                <div class="zone-fill"
                                                    style="width:{{ min(100, $pct) }}%;background:{{ $pct >= 100 ? '#ef4444' : ($pct >= 85 ? '#f59e0b' : '#14b8a6') }};">
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                        ...
                        <div class="col-md-6">
                            <div class="panel-card">
                                <div class="panel-header">
                                    <h6><i class="fas fa-layer-group mr-1 text-danger"></i> Lokasi dengan Slot Paling
                                        Sedikit</h6>
                                        ...
                                        <div class="zone-row">
                                            <div class="zone-label">
                                                ...
                                                <span style="font-size:12px;color:#6b7280;">
                                                    sisa <strong
                                                        style="color:{{ $cell['remaining'] == 0 ? '#ef4444' : '#374151' }};">{{ $cell['remaining'] }}</strong>
                                                    slot
                                                </span>
                                            </div>
                                            <div class="zone-bar">
            ...
            <div class="tab-pane fade" id="tab-topworst" role="tabpanel">
                <style>
                    ...
                    #topworstNav .nav-item {
                        flex: 1;
                    }

                    #topworstNav .nav-link {
                        display: block;
                        width: 100%;
                        text-align: center;
                        color: #6b7280;
                    ...
                    #topworstNav .nav-link.active {
                        color: #0d8564;
                        border-bottom-color: #0d8564;
                    }

                    #topworstNav .nav-link:hover:not(.active) {
                        color: #374151;
                        background: #f9fafb;
                                            ...
                                            @foreach ($topMovedItems as $i => $tm)
                                                <tr>
                                                    <td class="text-center" style="vertical-align:middle;">
                                                        ...
                                                        @else
                                                            <span
                                                                style="color:#9ca3af;font-weight:600;">{{ $i + 1 }}</span>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        <div style="font-weight:600;color:#1f2937;">
                                                            {{ $tm->item->name ?? '-' }}</div>
                                                        <code
                                                            style="font-size:11px;color:#9ca3af;">{{ $tm->item->sku ?? '' }}</code>
                                                    </td>
                                                    <td>
                                                        @if ($tm->item?->category)
                                                            <span class="badge"
                                                                style="font-size:11px;padding:3px 8px;background:{{ $tm->item->category->color_code ?? '#6366f1' }}22;color:{{ $tm->item->category->color_code ?? '#374151' }};border:1px solid {{ $tm->item->category->color_code ?? '#6366f1' }}55;">
                                        ...
                                        <tbody>
                                            @foreach ($worstMovedItems as $i => $wm)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div style="font-weight:600;color:#1f2937;">{{ $wm->name ?? '-' }}
                                                        </div>
                                                        <code
                                                            style="font-size:11px;color:#9ca3af;">{{ $wm->sku ?? '' }}</code>
                                                    </td>
                                                    <td>
                                                        @if ($wm->category)
                                                            <span class="badge"
                                                                style="font-size:11px;padding:3px 8px;background:{{ $wm->category->color_code ?? '#6366f1' }}22;color:{{ $wm->category->color_code ?? '#374151' }};border:1px solid {{ $wm->category->color_code ?? '#6366f1' }}55;">
                                                                {{ $wm->category->name }}
                                                            </span>
                                                        @else
                                                            <span class="text-muted" style="font-size:11px;">—</span>
                                                    ...
                                                    <td class="text-center"
                                                        style="font-weight:700;color:#ef4444;font-size:14px;">
                ...
                <div class="row">
                    ...
                    <div class="{{ $isOp ? 'col-md-7' : 'col-md-5' }} d-flex">
                        <div class="panel-card w-100">
                            <div class="panel-header">
                                <h6><i class="fas fa-dolly mr-1" style="color:#0d8564;"></i> Aktivitas Put-Away Hari Ini
                                </h6>
                                <span style="font-size:12px;color:#6b7280;">
                    ...
                    @if (!auth()->user()->hasRole('operator'))
                        <div class="col-md-4">
                            <div class="panel-card">
                                <div class="panel-header">
                                    <h6><i class="fas fa-dna mr-1" style="color:#8b5cf6;"></i> Statistik Genetic Algorithm
                                    </h6>
                                </div>
                                <div class="panel-body">
                                    <div class="row text-center mb-3">
                                        <div class="col-4">
                                            <div style="font-size:24px;font-weight:700;color:#8b5cf6">{{ $gaTotal }}
                                            </div>
                                            <small class="text-muted" style="font-size:11px">Total GA Run</small>
                                        </div>
                                        <div class="col-4">
                                            <div style="font-size:24px;font-weight:700;color:#0d8564">{{ $gaAccepted }}
                                            </div>
                                            <small class="text-muted" style="font-size:11px">Diterima</small>
                                        </div>
                                        <div class="col-4">
                                            <div style="font-size:24px;font-weight:700;color:#ef4444">{{ $gaRejected }}
                                            </div>
                                    ...
                                    <div class="zone-row">
                                        <div class="zone-label">
                                            <span>Acceptance Rate
                                                <i class="fas fa-info-circle text-muted ml-1"
                                                    style="font-size:11px;cursor:pointer" data-toggle="tooltip"
                                                    data-placement="top"
                                        ...
                                        <div class="zone-bar">
                                            <div class="zone-fill"
                                                style="width:{{ $gaAcceptRate }}%;background:#0d8564;"></div>
                                        </div>
                                    </div>
                                    <div class="zone-row">
                                        <div class="zone-label">
                                        ...
                                        <div class="zone-bar">
                                            <div class="zone-fill"
                                                style="width:{{ $followGaRate }}%;background:#3b82f6;"></div>
                                        </div>
                                    </div>
                            ...
                            <div class="panel-body">
                                @if (!auth()->user()->hasRole('operator'))
                                    <div class="zone-row">
                                        ...
                                        <div class="zone-bar">
                                            <div class="zone-fill"
                                                style="width:{{ $gaAcceptRate }}%;background:#8b5cf6;"></div>
                                        </div>
                                    </div>
                                    <div class="zone-row">
                                        <div class="zone-label">
                                ...
                                @if (!auth()->user()->hasRole('operator'))
                                    <div class="zone-row">
                                        ...
                                        <div class="zone-bar">
                                            <div class="zone-fill"
                                                style="width:{{ $gaAvgFitness }}%;background:#14b8a6;"></div>
                                        </div>
                                    </div>
                                @endif
            ...
            @if (!auth()->user()->hasRole('operator'))
                <div class="tab-pane fade" id="tab-ga" role="tabpanel">
                    <div class="tab-pane-header">
                        <div>
                            <div class="tab-pane-title"><i class="fas fa-dna mr-2" style="color:#8b5cf6;"></i>Analitik
...
@push('scripts')
    ...
    <script>
        ...
        function showChartLoadError() {
            document.querySelectorAll('.hc-chart').forEach((el) => {
                if (!el.dataset.chartError) {
                    ...
                    el.innerHTML =
                        '<div class="text-center text-muted py-4" style="font-size:12px;">Chart belum bisa dimuat. Periksa koneksi CDN Highcharts.</div>';
                }
            });
        }
            ...
            @endphp
                (function() {
                    ...
                    function renderTrend(res) {
                        ...
                        $('#trendNetFlowStat').text(net.toLocaleString()).css('color', net >= 0 ? '#0d8564' :
                        '#ef4444');
                        if (trendChart) {
                            trendChart.destroy();
                            trendChart = null;
                        ...
                        if (res.total_inbound + res.total_outbound === 0) {
                            $('#chartDailyInOutTrend').html(
                                '<div class="chart-empty"><div><i class="fas fa-chart-line"></i>Belum ada transaksi pada periode ini.</div></div>'
                                );
                            return;
                        }
                        $('#chartDailyInOutTrend').html('');
        ...
        function renderKapasitasCharts() {
            ...
            Highcharts.chart('chartZoneDonut', {
                ...
                series: [{
                    ...
                    data: [{
                            name: 'Terpakai',
                            y: {{ (int) $capacityUsedTotal }},
                            color: '#0d8564'
                        },
                        {
                            name: 'Kosong',
                            y: {{ (int) $capacityFreeTotal }},
                            color: '#e5e7eb'
                        }
                    ]
                }]
            ...
            Highcharts.chart('chartOrderStatus', {
                ...
                tooltip: {
                    pointFormat: '<b>{point.y}</b> DO ({point.percentage:.1f}%)'
                },
                plotOptions: {
                    pie: {
                        innerSize: '60%',
                ...
                series: [{
                    ...
                    data: {!! json_encode(
                        array_map(
                            fn($label, $value, $color) => ['name' => $label, 'y' => $value, 'color' => $color],
                            $osLabels,
                            $osData,
                            $osColors,
                        ),
        ...
        @if (!auth()->user()->hasRole('operator'))
            ...
            function renderGaCharts() {
                ...
                Highcharts.chart('chartGaTrend', {
                    ...
                    xAxis: {
                        categories: {!! json_encode($gaTrendLabels) !!},
                        crosshair: true
                    },
                    yAxis: [{
                        min: 0,
                ...
                Highcharts.chart('chartGaFitnessDistribution', {
                    ...
                    xAxis: {
                        categories: {!! json_encode(array_keys($gaFitnessDistribution)) !!},
                        title: {
                            text: null
                        }
                    },
                    ...
                    tooltip: {
                        pointFormat: '<b>{point.y}</b> GA run'
                    },
                    plotOptions: {
                        bar: {
                            borderRadius: 4,
                            colorByPoint: true,
                            colors: ['#ef4444', '#f59e0b', '#3b82f6', '#0d8564']
                        }
                    },
                    series: [{
                        name: 'Jumlah GA Run',
        ...
        $(document).on('click', '.kpi-tab-link', function(e) {
            ...
            $('html, body').animate({
                scrollTop: $('#dashboardTabs').offset().top - 60
            }, 300);
        });
